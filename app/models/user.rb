...
class User < ActiveRecord::Base
    ...
    validates :email, :presence => { :message => "Sähköpostiosoite on pakollinen" }, :format => { :with => VALID_EMAIL_REGEX, :message => "Sähköpostiosoitteen muoto on virheellinen" }, :uniqueness => { :case_sensitive => false }
