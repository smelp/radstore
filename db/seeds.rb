...
Hasstoragelocation.create(:batch_id => 1, :storagelocation_id => 1, :amount => 6, :batchType => 51)
Hasstoragelocation.create(:batch_id => 2, :storagelocation_id => 1, :amount => 3, :batchType => 52)
Hasstoragelocation.create(:batch_id => 2, :storagelocation_id => 2, :amount => 3, :batchType => 52)
Hasstoragelocation.create(:batch_id => 3, :storagelocation_id => 1, :amount => 6, :batchType => 53)
